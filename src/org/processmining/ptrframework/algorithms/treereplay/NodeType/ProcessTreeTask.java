...
public class ProcessTreeTask extends ProcessTreeNode {
    public ProcessTreeTask(ProcessTreeNode parent, XFactory xFactory, Node node) {
    ...
    public void updateParent(ProcessTreeNode childFired, XEvent eventCreated, boolean closed, boolean includeSilent, boolean isSilent) {
        ...
        if (parent != null) {
            parent.updateParent(this, eventCreated, true, includeSilent, false);
        }
    }
}
